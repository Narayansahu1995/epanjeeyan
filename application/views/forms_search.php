              ...
              <form class="row g-3" action="form-db" method="post">
                <div class="col-md-6" hidden>
                  ...
                  <?php
                    foreach($test as $row){
                  ?>
                  <input type="text" class="form-control" name="district" id="district" value="<?=$row->district_id?>">
                  ...
                  <!-- <select name="district" id="district" class="form-select">
                    ...
                    <?php
                    foreach($test as $row){
                      echo '<option value="'.$row->district_id.'">'.$row->sro_name.'</option>';
                    }
                    ?>
                  </select> -->
                </div>
                <div class="col-md-6" hidden>
                  ...
                  <?php
                    foreach($test as $row){
                  ?>
                  <input type="text" class="form-control" name="tehsil" id="tehsil" value="<?=$row->tehsil_id?>">
                ...
                <div class="col-md-6" hidden>
                  <label for="inputState" class="form-label">SRO Id</label>

                  <?php
                    foreach($test as $row){
                  ?>
                  <input type="text" class="form-control" name="sro_id" id="sro_id" value="<?=$row->id?>">
